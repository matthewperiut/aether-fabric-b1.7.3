...
public class EntityWhirly extends EntityAetherAnimal implements MobSpawnDataProvider {
    ...
    public void tickLiving() {
        ...
        if (this.entcount >= 128) {
            if (this.evil && this.target != null) {
                ...
                entitycreeper.setPositionAndAngles(this.x, this.y - 0.75, this.z, this.random.nextFloat() * 360.0F, 0.0F);
    ...
    public boolean canSpawn() {
        ...
        if (this.world.canSpawnEntity(this.boundingBox) && this.world.getEntities(this, this.boundingBox).size() == 0 && !this.world.isBoxSubmergedInFluid(this.boundingBox)) {
    ...
    public void writeNbt(NbtCompound nbttagcompound) {
        ...
        nbttagcompound.putInt("Life", (short) this.Life);
        nbttagcompound.putInt("Counter", (short) this.entcount);
