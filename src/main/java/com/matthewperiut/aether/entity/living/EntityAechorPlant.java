...
public class EntityAechorPlant extends EntityAetherAnimal implements MobSpawnDataProvider {
    ...
    public void tickMovement() {
        ...
        if (this.target != null) {
            if (!this.target.dead && !((double) this.target.getDistance(this) > 12.0)) {
            ...
            if (this.target != null && this.attTime >= 20 && this.method_928(this.target) && (double) this.target.getDistance(this) < 5.5 + (double) this.size / 2.0) {
                this.shootTarget();
                this.attTime = -10;
            }
