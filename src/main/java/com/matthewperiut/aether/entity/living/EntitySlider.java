...
public class EntitySlider extends FlyingEntity implements BossLivingEntity, MobSpawnDataProvider {
                    ...
                    if (!tool.isSuitableFor(Block.STONE)) {
                        ...
                        if (flag) {
                            ...
                            if (this.health <= 0) {
                                ...
                                this.world.setBlock(this.dungeonX + 7, this.dungeonY + 1, this.dungeonZ + 7, Block.TRAPDOOR.id, 3);
                                this.world.setBlock(this.dungeonX + 8, this.dungeonY + 1, this.dungeonZ + 7, Block.TRAPDOOR.id, 2);
                                this.world.setBlock(this.dungeonX + 7, this.dungeonY + 1, this.dungeonZ + 8, Block.TRAPDOOR.id, 3);
                                this.world.setBlock(this.dungeonX + 8, this.dungeonY + 1, this.dungeonZ + 8, Block.TRAPDOOR.id, 2);
    ...
    private void unlockBlock(int i, int j, int k) {
        ...
        if (id == AetherBlocks.LockedDungeonStone.id) {
            this.world.setBlock(i, j, k, AetherBlocks.DungeonStone.id, this.world.getBlockMeta(i, j, k));
        ...
        if (id == AetherBlocks.LockedLightDungeonStone.id) {
            this.world.setBlock(i, j, k, AetherBlocks.LightDungeonStone.id, this.world.getBlockMeta(i, j, k));
            this.unlockBlock(i + 1, j, k);
            this.unlockBlock(i - 1, j, k);
            this.unlockBlock(i, j + 1, k);
            this.unlockBlock(i, j - 1, k);
