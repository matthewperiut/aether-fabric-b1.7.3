...
public class EntityMoa extends EntityAetherAnimal implements MobSpawnDataProvider {
    ...
    public EntityMoa(World world, boolean babyBool, boolean grownBool, boolean saddledBool, MoaColor moaColor) {
        super(world);
        this.petalsEaten = 0;
        this.wellFed = false;
        ...
        this.color = moaColor;
        this.texture = this.color.getTexture(this.saddled);
    ...
    public void tickMovement() {
        ...
        if (!this.world.isRemote && !this.baby && --this.timeUntilNextEgg <= 0) {
            ...
            this.dropItem(new ItemStack(AetherItems.MoaEgg, 1, this.color.ID), 0.0F);
            this.timeUntilNextEgg = this.random.nextInt(6000) + 6000;
        }
    ...
    public void writeNbt(NbtCompound nbttagcompound) {
        ...
        nbttagcompound.putShort("ColorNumber", (short) this.color.ID);
    ...
    public void readNbt(NbtCompound nbttagcompound) {
        ...
        this.color = MoaColor.getColor(nbttagcompound.getShort("ColorNumber"));
    ...
    public boolean interact(PlayerEntity entityplayer) {
        if (!this.saddled && this.grown && !this.baby && entityplayer.inventory.getSelectedItem() != null && entityplayer.inventory.getSelectedItem().itemId == Item.SADDLE.id) {
            ...
            if (itemstack != null && itemstack.itemId == AetherItems.AechorPetal.id) {
                ...
                if (this.petalsEaten > this.color.jumps) {
                    this.grown = true;
                    this.baby = false;
                }
