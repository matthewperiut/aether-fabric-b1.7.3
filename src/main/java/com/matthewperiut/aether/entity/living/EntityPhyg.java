...
public class EntityPhyg extends EntityAetherAnimal implements RetroMobSpawnData, MountInput {
    ...
    protected void initDataTracker() {
        ...
        this.dataTracker.startTracking(17, (byte) 0);  // jrem (jumps remaining)
    }
