...
public class EntityZephyr extends FlyingEntity implements Monster, MobSpawnDataProvider {
        ...
        if (this.targetedEntity != null && this.targetedEntity.getSquaredDistance(this) < d5 * d5) {
            ...
            if (this.method_928(this.targetedEntity)) {
                ...
                if (this.attackCounter == 20) {
                    ...
                    final double d9 = 4.0;
                    // method_926 > getRotation
                    Vec3d vec3d = this.method_926(1.0F);
    ...
    public boolean canSpawn() {
        ...
        boolean flag = this.random.nextInt(85) == 0 && this.world.canSpawnEntity(this.boundingBox) && this.world.getEntities(this, this.boundingBox).size() == 0
