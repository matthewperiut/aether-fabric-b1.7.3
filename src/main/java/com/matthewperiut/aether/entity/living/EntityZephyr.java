...
public class EntityZephyr extends FlyingEntity implements Monster, MobSpawnDataProvider {
    ...
    protected void tickHandSwing() {
        ...
        if (this.courseChangeCooldown-- <= 0) {
            ...
            if (this.isCourseTraversable(this.waypointX, this.waypointY, this.waypointZ, d4)) {
                this.xVelocity += d / d4 * 0.1;
                this.yVelocity += d2 / d4 * 0.1;
                this.zVelocity += d3 / d4 * 0.1;
            } else {
        ...
        if (this.targetedEntity == null || this.aggroCooldown-- <= 0) {
            this.targetedEntity = this.world.getClosestPlayerTo(this, 100.0);
        ...
        if (this.targetedEntity != null && this.targetedEntity.method_1352(this) < d5 * d5) {
            ...
            if (this.method_928(this.targetedEntity)) {
                if (this.attackCounter == 10) {
                    this.world.playSound(this, "aether:mobs.zephyr.zephyrcall", this.getSoundVolume(), (this.rand.nextFloat() - this.rand.nextFloat()) * 0.2f + 1.0f);
                }
                ++this.attackCounter;
                if (this.attackCounter == 20) {
                    this.world.playSound(this, "aether:mobs.zephyr.zephyrshoot", this.getSoundVolume(), (this.rand.nextFloat() - this.rand.nextFloat()) * 0.2f + 1.0f);
                    final EntityZephyrSnowball entitysnowball = new EntityZephyrSnowball(this.world, this, d6, d7, d8);
                    final double d9 = 4.0;
                    Vec3d vec3d = this.getRotation(1.0F);
            ...
            this.field_1012 = this.yaw = -((float) Math.atan2(this.xVelocity, this.zVelocity)) * 180.0F / 3.141593F;
    ...
    public boolean canSpawn() {
        ...
        boolean flag = this.rand.nextInt(85) == 0 && this.world.canSpawnEntity(this.boundingBox) && this.world.method_190(this, this.boundingBox).size() == 0
                && !this.world.method_218(this.boundingBox) && this.world.getBlockId(i, j - 1, k) != AetherBlocks.DungeonStone.id &&
