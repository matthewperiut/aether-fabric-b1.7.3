...
public class EntityLightningKnife extends Entity implements EntitySpawnDataProvider {
    ...
    public EntityLightningKnife(World world, LivingEntity entityliving) {
        super(world);
    ...
    public void tick() {
        ...
        Vec3d vec3d1 = Vec3d.create(this.x + this.velocityX, this.y + this.velocityY, this.z + this.velocityZ);
        HitResult movingobjectposition = this.world.raycast(vec3d, vec3d1);
        vec3d = Vec3d.create(this.x, this.y, this.z);
        vec3d1 = Vec3d.create(this.x + this.velocityX, this.y + this.velocityY, this.z + this.velocityZ);
        if (movingobjectposition != null) {
            vec3d1 = Vec3d.create(movingobjectposition.pos.x, movingobjectposition.pos.y, movingobjectposition.pos.z);
        }
        ...
        if (movingobjectposition != null) {
            ...
            if (movingobjectposition.entity != null) {
                ...
                entitylightningbolt.setPositionAndAngles((double) x, (double) y, (double) z, this.yaw, 0.0F);
    ...
    public void onPlayerInteraction(PlayerEntity entityplayer) {
        // method_671 > addStack
        if (this.inGroundSnowball && this.thrower == entityplayer && this.shakeSnowball <= 0 && entityplayer.inventory.method_671(new ItemStack(Item.ARROW, 1))) {
