...
public class AetherGenDungeonSilver extends AetherGenBuildings {
        ...
        if (!this.isBoxEmpty(world, i, j, k, 55, 20, 30)) {
                ...
                for (int q = 0; q < 3; ++q) {
                    ...
                    for (r = 0; r < 3; ++r) {
                        ...
                        if (type >= 3) {
                            switch (roomType) {
                                case 0:
                                    world.setBlock(i + 7 + p * 7, j - 1 + q * 5, k + 7 + r * 7, AetherBlocks.Trap.id, 1);
                                    break;
                                case 1:
            ...
            for (x = 0; x < 24; ++x) {
                for (z = 0; z < 20; ++z) {
                    ...
                    if (p == 21) {
                        world.setBlock(i + 26 + x, j, k + 5 + z, this.lockedBlockID2, 1);
                    } else if (p > 21) {
                        world.setBlock(i + 26 + x, j, k + 5 + z, this.lockedBlockID1, 1);
                    }
                }
            }
            ...
            world.setBlock(i + 35, j + 1, k + 7, this.lockedBlockID1, 1);
            world.setBlock(i + 40, j + 1, k + 7, this.lockedBlockID1, 1);
            ...
            world.setBlock(i + 35, j + 1, k + 22, this.lockedBlockID1, 1);
            world.setBlock(i + 40, j + 1, k + 22, this.lockedBlockID1, 1);
            ...
            world.setBlock(x, y - 13, z + 1, AetherBlocks.TreasureChest.id, 3);
            world.setBlockWithoutNotifyingNeighbors(x, j - 1, z, 2);
            return true;
        }
    }
    ...
    private void addColumn(World world, Random random, int i, int j, int k, int h) {
        ...
        world.setBlock(i + 1, j + h - 1, k + 1, this.columnID, 1);
    }
