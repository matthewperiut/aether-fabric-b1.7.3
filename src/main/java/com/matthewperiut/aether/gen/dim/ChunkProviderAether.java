...
public class ChunkProviderAether implements ChunkManager {
    public static int gumCount;
    private final Random random;

    // class_209 is PerlinOctaveNoise (Sampler)
    ...
    public void func_28072_a(int i, int j, byte[] abyte0, Biome[] abiomegenbase) {
        double d = 0.03125;
        this.field_28079_r = this.noiseGenerator4.method_1514(this.field_28079_r, i * 16, j * 16, 0.0, 16, 16, 1, d, d, 1.0);
        this.field_28078_s = this.noiseGenerator4.method_1514(this.field_28078_s, i * 16, 109.0134, j * 16, 16, 1, 16, d, 1.0, d);
        this.field_28077_t = this.noiseGenerator5.method_1514(this.field_28077_t, i * 16, j * 16, 0.0, 16, 16, 1, d * 2.0, d * 2.0, d * 2.0);
    ...
    public Chunk getChunk(int i, int j) {
        ...
        this.field_28075_v = this.worldObj.method_1781().method_1791(this.field_28075_v, i * 16, j * 16, 16, 16);
        double[] ad = this.worldObj.method_1781().field_2235;
        this.func_28071_a(i, j, abyte0, this.field_28075_v, ad);
        this.func_28072_a(i, j, abyte0, this.field_28075_v);
        this.mapGenCaves.method_395(this, this.worldObj, i, j, abyte0);
        // generateHeightMap
        chunk.method_873();
    ...
    private double[] func_28073_a(double[] ad, int i, int j, int k, int l, int i1, int j1) {
        ...
        double d = 684.412;
        double d1 = 684.412;
        double[] ad1 = this.worldObj.method_1781().field_2235;
        double[] ad2 = this.worldObj.method_1781().field_2236;
        this.field_28090_g = this.noiseGenerator6.method_1515(this.field_28090_g, i, k, l, j1, 1.121, 1.121, 0.5);
        this.field_28089_h = this.noiseGenerator7.method_1515(this.field_28089_h, i, k, l, j1, 200.0, 200.0, 0.5);
        d *= 2.0;
        this.field_28093_d = this.noiseGenerator3.method_1514(this.field_28093_d, i, j, k, l, i1, j1, d / 80.0, d1 / 160.0, d / 80.0);
        this.field_28092_e = this.noiseGenerator1.method_1514(this.field_28092_e, i, j, k, l, i1, j1, d, d1, d);
        this.field_28091_f = this.noiseGenerator2.method_1514(this.field_28091_f, i, j, k, l, i1, j1, d, d1, d);
        int k1 = 0;
        int l1 = 0;
        int i2 = 16 / l;
    ...
    public void decorate(ChunkManager ichunkprovider, int i, int j) {
        ...
        d = 0.5;
        k4 = (int) ((this.noiseGenerator8.method_1513((double) k * d, (double) l * d) / 8.0 + this.random.nextDouble() * 4.0 + 4.0) / 3.0);
        l7 = 0;
