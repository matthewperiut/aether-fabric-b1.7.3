...
public class ChunkProviderAether implements WorldSource
{
    ...
    private PerlinOctaveNoise noiseGenerator3;
    private PerlinOctaveNoise noiseGenerator4;
    private PerlinOctaveNoise noiseGenerator5;
    ...
    private Carver mapGenCaves = new OverworldCarver();
    ...
    {
        double d = 0.03125;
        this.field_28079_r = this.noiseGenerator4.sample(this.field_28079_r, (double) (i * 16), (double) (j * 16), 0.0, 16, 16, 1, d, d, 1.0);
        this.field_28078_s = this.noiseGenerator4.sample(this.field_28078_s, (double) (i * 16), 109.0134, (double) (j * 16), 16, 1, 16, d, 1.0, d);
        this.field_28077_t = this.noiseGenerator5.sample(this.field_28077_t, (double) (i * 16), (double) (j * 16), 0.0, 16, 16, 1, d * 2.0, d * 2.0, d * 2.0);
    ...
    private double[] func_28073_a(double[] ad, int i, int j, int k, int l, int i1, int j1)
    {
        ...
        d *= 2.0;
        this.field_28093_d = this.noiseGenerator3.sample(this.field_28093_d, (double) i, (double) j, (double) k, l, i1, j1, d / 80.0, d1 / 160.0, d / 80.0);
        this.field_28092_e = this.noiseGenerator1.sample(this.field_28092_e, (double) i, (double) j, (double) k, l, i1, j1, d, d1, d);
        this.field_28091_f = this.noiseGenerator2.sample(this.field_28091_f, (double) i, (double) j, (double) k, l, i1, j1, d, d1, d);
        int k1 = 0;
        int l1 = 0;
        int i2 = 16 / l;
    ...
    public void decorate(WorldSource ichunkprovider, int i, int j)
    {
        ...
        for (k17 = 0; k17 < l7; ++k17)
        {
            ...
            Feature worldgenerator = (Feature) (random.nextInt(100) == 0 ? new AetherGenGoldenOak() : new AetherGenSkyroot());
