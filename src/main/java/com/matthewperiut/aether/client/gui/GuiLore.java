...
public class GuiLore extends HandledScreen {
    ...
    static {
        ...
        GuiLore.lores.add(new Lore(Item.DIAMOND, "Diamond", "Found deep under-", "ground. Very rare.", "Used for diamond", "tools, armor and", "jukeboxes", "", 0));
        GuiLore.lores.add(new Lore(Item.IRON_INGOT, "Iron Ingot", "Refined Iron.", "Makes iron tools,", "armor, rails,", "minecarts, doors,", "buckets and", "compasses", 0));
        GuiLore.lores.add(new Lore(Item.GOLD_INGOT, "Gold Ingot", "Refined Gold.", "Makes gold tools,", "armor and ", "watches", "", "", 0));
        ...
        GuiLore.lores.add(new Lore(Item.LEATHER, "Leather", "Dropped by cows.", "Used in making", "leather armor", "", "", "", 0));
        ...
        GuiLore.lores.add(new Lore(AetherItems.ObsidianHelm, "Obsidian Helmet", "A cooled version of", "the Phoenix", "Helmet.", "Incredibly strong", "head armor", "", 2));
        GuiLore.lores.add(new Lore(AetherItems.ObsidianBody, "Obsidian Chestplate", "A cooled version of", "the Phoenix", "Chestplate.", "Incredibly strong", "chest armor", "", 2));
        GuiLore.lores.add(new Lore(AetherItems.ObsidianLegs, "Obsidian Greaves", "A cooled version of", "the Phoenix", "Leggings.", "Incredibly strong", "leg armor", "", 2));
        GuiLore.lores.add(new Lore(AetherItems.ObsidianBoots, "Obsidian Boots", "A cooled version of", "the Phoenix", "Boots.", "Incredibly strong", "foot armor", "", 2));
        ...
        GuiLore.lores.add(new Lore(AetherItems.ObsidianGlove, "Obsidian Glove", "A cooled version of", "the Phoenix", "Glove.", "Incredibly strong", "hand armor", "", 2));
    ...
    protected void drawForeground() {
        this.textRenderer.drawWithShadow("Book Of Lore", 37, 18, 4210752);
        this.textRenderer.drawWithShadow("Volume " + (this.type + 1), 47, 28, 4210752);
        switch (this.type) {
            case 0: {
                this.textRenderer.drawWithShadow("The Surface", 37, 38, 4210752);
                break;
            }
            case 1: {
                this.textRenderer.drawWithShadow("The Nether", 37, 38, 4210752);
                break;
            }
            case 2: {
                this.textRenderer.drawWithShadow("The Aether", 37, 38, 4210752);
                break;
            }
        }
        this.textRenderer.drawWithShadow("Item : ", 46, 72, 4210752);
        ...
        if (item != null) {
            for (final Lore lore : GuiLore.lores) {
                if (lore.equals(item) && lore.type == this.type) {
                    this.textRenderer.drawWithShadow(lore.name, 134, 14, 4210752);
                    this.textRenderer.drawWithShadow(lore.line1, 134, 28, 4210752);
                    this.textRenderer.drawWithShadow(lore.line2, 134, 38, 4210752);
                    this.textRenderer.drawWithShadow(lore.line3, 134, 48, 4210752);
                    this.textRenderer.drawWithShadow(lore.line4, 134, 58, 4210752);
                    this.textRenderer.drawWithShadow(lore.line5, 134, 68, 4210752);
                    this.textRenderer.drawWithShadow(lore.line6, 134, 78, 4210752);
