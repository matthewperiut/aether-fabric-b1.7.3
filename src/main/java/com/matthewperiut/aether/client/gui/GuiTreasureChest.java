...
public class GuiTreasureChest extends HandledScreen {
    ...
    protected void drawForeground() {
        this.textRenderer.drawWithShadow(this.name, 8, 6, 4210752);
        this.textRenderer.drawWithShadow(this.upperChestInventory.getName(), 8, this.backgroundHeight - 96 + 2, 4210752);
    }
