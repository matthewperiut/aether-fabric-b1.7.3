...
public class AetherEntityRenderers {
      ...
      public void registerEntityRenderers(EntityRendererRegisterEvent event) {
        ...
        event.renderers.put(EntityFireMonster.class, new LivingEntityRenderer(new ModelFireMonster(0.0F, 0.0F), 0.4F));
        event.renderers.put(EntityFireMinion.class, new LivingEntityRenderer(new ModelFireMinion(0.0F, 0.0F), 0.4F));
