...
public class ClientPlayerEntityMixinPlayCustomAchievementSounds {
    @Shadow
    protected Minecraft minecraft;

    @Redirect(method = "increaseStat", at = @At(value = "INVOKE", target = "Lnet/minecraft/client/gui/hud/toast/AchievementToast;method_1964(Lnet/minecraft/achievement/Achievement;)V"))
    // method_1964 is "setGotAchievement" in AchievementToast or something
    public void onSetAchievement(AchievementToast instance, Achievement achievement) {
        ...
        instance.method_1964(achievement);
    }
}
