...
public class AetherItems {
    ...
    public void registerItems(ItemRegistryEvent event) {
        ...
        PhoenixHelm = new ItemPhoenixArmor(Identifier.of(MOD_ID, "item_phoenix_helmet"), 3, "Phoenix", 0, 16742144).setTextureId(1).setTranslationKey(MOD_ID, "item_phoenix_helmet");
        PhoenixBody = new ItemPhoenixArmor(Identifier.of(MOD_ID, "item_phoenix_body"), 3, "Phoenix", 1, 16742144).setTextureId(17).setTranslationKey(MOD_ID, "item_phoenix_body");
        PhoenixLegs = new ItemPhoenixArmor(Identifier.of(MOD_ID, "item_phoenix_legs"), 3, "Phoenix", 2, 16742144).setTextureId(33).setTranslationKey(MOD_ID, "item_phoenix_legs");
        PhoenixBoots = new ItemPhoenixArmor(Identifier.of(MOD_ID, "item_phoenix_boots"), 3, "Phoenix", 3, 16742144).setTextureId(49).setTranslationKey(MOD_ID, "item_phoenix_boots");
        ObsidianHelm = new ItemColoredArmor(Identifier.of(MOD_ID, "item_obsidian_helmet"), 4, "Obsidian", 0, 1774663).setTextureId(2).setTranslationKey(MOD_ID, "item_obsidian_helmet");
        ObsidianBody = new ItemColoredArmor(Identifier.of(MOD_ID, "item_obsidian_body"), 4, "Obsidian", 1, 1774663).setTextureId(18).setTranslationKey(MOD_ID, "item_obsidian_body");
        ObsidianLegs = new ItemColoredArmor(Identifier.of(MOD_ID, "item_obsidian_legs"), 4, "Obsidian", 2, 1774663).setTextureId(34).setTranslationKey(MOD_ID, "item_obsidian_legs");
        ObsidianBoots = new ItemColoredArmor(Identifier.of(MOD_ID, "item_obsidian_boots"), 4, "Obsidian", 3, 1774663).setTextureId(50).setTranslationKey(MOD_ID, "item_obsidian_boots");
        GravititeHelmet = new ItemColoredArmor(Identifier.of(MOD_ID, "item_gravitite_helmet"), 3, "Gravitite", 0, 15160027).setTextureId(2).setTranslationKey(MOD_ID, "item_gravitite_helmet");
        GravititeBodyplate = new ItemColoredArmor(Identifier.of(MOD_ID, "item_gravitite_body"), 3, "Gravitite", 1, 15160027).setTextureId(18).setTranslationKey(MOD_ID, "item_gravitite_body");
        GravititePlatelegs = new ItemColoredArmor(Identifier.of(MOD_ID, "item_gravitite_legs"), 3, "Gravitite", 2, 15160027).setTextureId(34).setTranslationKey(MOD_ID, "item_gravitite_legs");
        GravititeBoots = new ItemColoredArmor(Identifier.of(MOD_ID, "item_gravitite_boots"), 3, "Gravitite", 3, 15160027).setTextureId(50).setTranslationKey(MOD_ID, "item_gravitite_boots");
        ZaniteHelmet = new ItemColoredArmor(Identifier.of(MOD_ID, "item_zanite_helmet"), 2, "Zanite", 0, 7412456).setTextureId(2).setTranslationKey(MOD_ID, "item_zanite_helmet");
        ZaniteChestplate = new ItemColoredArmor(Identifier.of(MOD_ID, "item_zanite_body"), 2, "Zanite", 1, 7412456).setTextureId(18).setTranslationKey(MOD_ID, "item_zanite_body");
        ZaniteLeggings = new ItemColoredArmor(Identifier.of(MOD_ID, "item_zanite_legs"), 2, "Zanite", 2, 7412456).setTextureId(34).setTranslationKey(MOD_ID, "item_zanite_legs");
        ZaniteBoots = new ItemColoredArmor(Identifier.of(MOD_ID, "item_zanite_boots"), 2, "Zanite", 3, 7412456).setTextureId(50).setTranslationKey(MOD_ID, "item_zanite_boots");
        NeptuneHelmet = new ItemColoredArmor(Identifier.of(MOD_ID, "item_neptune_helmet"), 3, "Neptune", 0, 2512127).setTextureId(1).setTranslationKey(MOD_ID, "item_neptune_helmet");
        NeptuneChestplate = new ItemColoredArmor(Identifier.of(MOD_ID, "item_neptune_body"), 3, "Neptune", 1, 2512127).setTextureId(17).setTranslationKey(MOD_ID, "item_neptune_body");
        NeptuneLeggings = new ItemColoredArmor(Identifier.of(MOD_ID, "item_neptune_legs"), 3, "Neptune", 2, 2512127).setTextureId(33).setTranslationKey(MOD_ID, "item_neptune_legs");
        NeptuneBoots = new ItemColoredArmor(Identifier.of(MOD_ID, "item_neptune_boots"), 3, "Neptune", 3, 2512127).setTextureId(49).setTranslationKey(MOD_ID, "item_neptune_boots");
