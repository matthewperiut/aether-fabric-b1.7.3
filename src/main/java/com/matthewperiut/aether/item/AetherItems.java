...
public class AetherItems {
    ...
    public void registerItems(ItemRegistryEvent event) {
        ...
        PhoenixGlove = (new ItemGloves(Identifier.of(MOD_ID, "phoenix_glove"), 3, "aether:stationapi/textures/armour/Phoenix.png", 10, 16742144, false)).setTranslationKey(MOD_ID, "phoenix_glove");
