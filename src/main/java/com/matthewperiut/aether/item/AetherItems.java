...
public class AetherItems
{
    ...
    public void registerItems(ItemRegistryEvent event)
    {
        ...
        PhoenixHelm = new ItemPhoenixArmour(Identifier.of(MOD_ID, "item_phoenix_helmet"), 3, "Phoenix", 0, 16742144).setTexturePosition(1).setTranslationKey(MOD_ID, "item_phoenix_helmet");
        PhoenixBody = new ItemPhoenixArmour(Identifier.of(MOD_ID, "item_phoenix_body"), 3, "Phoenix", 1, 16742144).setTexturePosition(17).setTranslationKey(MOD_ID, "item_phoenix_body");
        PhoenixLegs = new ItemPhoenixArmour(Identifier.of(MOD_ID, "item_phoenix_legs"), 3, "Phoenix", 2, 16742144).setTexturePosition(33).setTranslationKey(MOD_ID, "item_phoenix_legs");
        PhoenixBoots = new ItemPhoenixArmour(Identifier.of(MOD_ID, "item_phoenix_boots"), 3, "Phoenix", 3, 16742144).setTexturePosition(49).setTranslationKey(MOD_ID, "item_phoenix_boots");
        ObsidianHelm = new ItemColouredArmour(Identifier.of(MOD_ID, "item_obsidian_helmet"), 4, "Obsidian", 0, 1774663).setTexturePosition(2).setTranslationKey(MOD_ID, "item_obsidian_helmet");
        ObsidianBody = new ItemColouredArmour(Identifier.of(MOD_ID, "item_obsidian_body"), 4, "Obsidian", 1, 1774663).setTexturePosition(18).setTranslationKey(MOD_ID, "item_obsidian_body");
        ObsidianLegs = new ItemColouredArmour(Identifier.of(MOD_ID, "item_obsidian_legs"), 4, "Obsidian", 2, 1774663).setTexturePosition(34).setTranslationKey(MOD_ID, "item_obsidian_legs");
        ObsidianBoots = new ItemColouredArmour(Identifier.of(MOD_ID, "item_obsidian_boots"), 4, "Obsidian", 3, 1774663).setTexturePosition(50).setTranslationKey(MOD_ID, "item_obsidian_boots");
        GravititeHelmet = new ItemColouredArmour(Identifier.of(MOD_ID, "item_gravitite_helmet"), 3, "Gravitite", 0, 15160027).setTexturePosition(2).setTranslationKey(MOD_ID, "item_gravitite_helmet");
        GravititeBodyplate = new ItemColouredArmour(Identifier.of(MOD_ID, "item_gravitite_body"), 3, "Gravitite", 1, 15160027).setTexturePosition(18).setTranslationKey(MOD_ID, "item_gravitite_body");
        GravititePlatelegs = new ItemColouredArmour(Identifier.of(MOD_ID, "item_gravitite_legs"), 3, "Gravitite", 2, 15160027).setTexturePosition(34).setTranslationKey(MOD_ID, "item_gravitite_legs");
        GravititeBoots = new ItemColouredArmour(Identifier.of(MOD_ID, "item_gravitite_boots"), 3, "Gravitite", 3, 15160027).setTexturePosition(50).setTranslationKey(MOD_ID, "item_gravitite_boots");
        ZaniteHelmet = new ItemColouredArmour(Identifier.of(MOD_ID, "item_zanite_helmet"), 2, "Zanite", 0, 7412456).setTexturePosition(2).setTranslationKey(MOD_ID, "item_zanite_helmet");
        ZaniteChestplate = new ItemColouredArmour(Identifier.of(MOD_ID, "item_zanite_body"), 2, "Zanite", 1, 7412456).setTexturePosition(18).setTranslationKey(MOD_ID, "item_zanite_body");
        ZaniteLeggings = new ItemColouredArmour(Identifier.of(MOD_ID, "item_zanite_legs"), 2, "Zanite", 2, 7412456).setTexturePosition(34).setTranslationKey(MOD_ID, "item_zanite_legs");
        ZaniteBoots = new ItemColouredArmour(Identifier.of(MOD_ID, "item_zanite_boots"), 2, "Zanite", 3, 7412456).setTexturePosition(50).setTranslationKey(MOD_ID, "item_zanite_boots");
        NeptuneHelmet = new ItemColouredArmour(Identifier.of(MOD_ID, "item_neptune_helmet"), 3, "Neptune", 0, 2512127).setTexturePosition(1).setTranslationKey(MOD_ID, "item_neptune_helmet");
        NeptuneChestplate = new ItemColouredArmour(Identifier.of(MOD_ID, "item_neptune_body"), 3, "Neptune", 1, 2512127).setTexturePosition(17).setTranslationKey(MOD_ID, "item_neptune_body");
        NeptuneLeggings = new ItemColouredArmour(Identifier.of(MOD_ID, "item_neptune_legs"), 3, "Neptune", 2, 2512127).setTexturePosition(33).setTranslationKey(MOD_ID, "item_neptune_legs");
        NeptuneBoots = new ItemColouredArmour(Identifier.of(MOD_ID, "item_neptune_boots"), 3, "Neptune", 3, 2512127).setTexturePosition(49).setTranslationKey(MOD_ID, "item_neptune_boots");
        ...
        LeatherGlove = (new ItemGloves(Identifier.of(MOD_ID, "leather_glove"), 0, "aether:stationapi/textures/armour/Accessories.png", 10, 12999733)).setTranslationKey(MOD_ID, "leather_glove");
        IronGlove = (new ItemGloves(Identifier.of(MOD_ID, "iron_glove"), 2, "aether:stationapi/textures/armour/Accessories.png", 10, 14540253)).setTranslationKey(MOD_ID, "iron_glove");
        GoldGlove = (new ItemGloves(Identifier.of(MOD_ID, "gold_glove"), 1, "aether:stationapi/textures/armour/Accessories.png", 10, 15396439)).setTranslationKey(MOD_ID, "gold_glove");
        DiamondGlove = (new ItemGloves(Identifier.of(MOD_ID, "diamond_glove"), 3, "aether:stationapi/textures/armour/Accessories.png", 10, 3402699)).setTranslationKey(MOD_ID, "diamond_glove");
        ZaniteGlove = (new ItemGloves(Identifier.of(MOD_ID, "zanite_glove"), 2, "aether:stationapi/textures/armour/Accessories.png", 10, 7412456)).setTranslationKey(MOD_ID, "zanite_glove");
        GravititeGlove = (new ItemGloves(Identifier.of(MOD_ID, "gravitite_glove"), 3, "aether:stationapi/textures/armour/Accessories.png", 10, 15160027)).setTranslationKey(MOD_ID, "gravitite_glove");
        PhoenixGlove = (new ItemPhoenixGloves(Identifier.of(MOD_ID, "phoenix_glove"), 3, "aether:stationapi/textures/armour/Phoenix.png", 10, 16742144, false)).setTranslationKey(MOD_ID, "phoenix_glove");
        ObsidianGlove = (new ItemGloves(Identifier.of(MOD_ID, "obsidian_glove"), 4, "aether:stationapi/textures/armour/Accessories.png", 10, 1774663)).setTranslationKey(MOD_ID, "obsidian_glove");
        NeptuneGlove = (new ItemGloves(Identifier.of(MOD_ID, "neptune_glove"), 3, "aether:stationapi/textures/armour/Accessories.png", 10, 2512127)).setTranslationKey(MOD_ID, "neptune_glove");
