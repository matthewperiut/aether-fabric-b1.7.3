...
public class ItemSkyrootBucket extends TemplateItem {
    ...
    public ItemStack use(ItemStack itemstack, World world, PlayerEntity entityplayer) {
        ...
        // field_2823 > hitResult
        if (((((Minecraft)FabricLoader.getInstance().getGameInstance()).field_2823) == null || (((Minecraft)FabricLoader.getInstance().getGameInstance()).field_2823).entity == null || !((((Minecraft)FabricLoader.getInstance().getGameInstance()).field_2823).entity instanceof EntityAechorPlant))) {
        ...
        if (movingobjectposition == null || movingobjectposition.type != HitResultType.BLOCK || itemstack.getDamage() != 0 && itemstack.getDamage() != Block.FLOWING_WATER.id) {
            if (itemstack.getDamage() == 0 && (((Minecraft)FabricLoader.getInstance().getGameInstance()).field_2823) != null && (((Minecraft)FabricLoader.getInstance().getGameInstance()).field_2823).entity != null && ((((Minecraft)FabricLoader.getInstance().getGameInstance()).field_2823).entity instanceof CowEntity ||(((Minecraft)FabricLoader.getInstance().getGameInstance()).field_2823).entity instanceof EntityFlyingCow)) {
            ...
            if (itemstack.getDamage() == 0) {
                ...
                // field_2176 > evaporatesWater
                if (world.isAir(i, j, k) || !world.getMaterial(i, j, k).isSolid()) {
                    if (world.dimension.field_2176 && itemstack.getDamage() == Block.FLOWING_WATER.id) {
